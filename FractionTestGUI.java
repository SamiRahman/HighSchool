...
//Sami Rahman
class FractionTestGUI extends JFrame
{
	...
	public void actionPerformed (ActionEvent e)
	{
	    ...
	    Fraction A = new Fraction (); //initialize
    ...
    /*class KeyListenerTF1 implements KeyListener
    {
	...
	public void keyReleased (KeyEvent e)
	{
	    ...
	    if (_fraction1TF.getCaretPosition () == 0 && (e.getKeyChar () e.getKeyChar () >= '0' && e.getKeyChar <= '9') || e.getKeyChar == '-')
	    {

	    }
	    else
		_fraction1TF.setText ();

	    _fration1TF.getCaretPosition (); //number of position of cursor starts at 0
	}
    }


    class KeyListenerTF2 implements KeyListener
    {
	public void keyTyped (KeyEvent e)
	{
	}
	...
	public void keyReleased (KeyEvent e)
	{
	    _fration2TF.getCaretPosition (); //number of position of cursor starts at 0
	}
    }*/
    ...
    {
	FractionTestGUI window = new FractionTestGUI ();
